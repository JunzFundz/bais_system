               ...
               <div class="p-4 md:p-5 space-y-4">
                   <form class=" w-full">
                       ...
                       <div class="grid md:grid-cols-3 md:gap-6">
                           ...
                           <div class="relative z-0 w-full mb-5 group">
                               <select type="date" name="floating_last_name" id="cs" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                               <?php if (!empty($status)) { ?>
                       ...
                       <div class="grid md:grid-cols-3 md:gap-6">
                           <div class="relative z-0 w-full mb-5 group">
                               ...
                               <?php if (!empty($position)) { ?>
                                   <?php foreach ($position as $row) { ?>
                                       <option value="<?= $row['POSITION_NAME']; ?>">
                                           <?= $row['POSITION_NAME']; ?>
                                       </option>
                                   <?php } ?>
                               <?php } else { ?>
                           ...
                           <div class="relative z-0 w-full mb-5 group">
                               <select type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="email" id="brgy" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                               <?php if (!empty($brgy)) { ?>
                                   <?php foreach ($brgy as $row) { ?>
                                       <option value="<?= $row['BRGY_ID']; ?>">
                                           <?= $row['BARANGAY']; ?>
                                       </option>
                                   <?php } ?>
                               <?php } else { ?>
