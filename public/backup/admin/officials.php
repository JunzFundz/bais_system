       ...
       <div class=" w-full max-w-7xl mr-auto ml-auto pt-6 pr-6 pb-6 space-y-8">
           ...
           <div class="bg-white rounded-2xl shadow-[0_2px_20px_-4px_rgba(0,0,0,0.04)] border border-slate-50 overflow-hidden">
               ...
               <div class="overflow-x-auto">
                   <table id="myTable2" class="w-full text-left border-collapse">
                       <thead class="">
                                       ...
                                       <td class="px-6 py-4">
                                           <div class="flex items-center gap-3">
                                               ...
                                               <span class="font-medium text-dark">
                                                   <?= htmlspecialchars($rows['F_NAME'] . " " . $rows['M_NAME'] . " " . $rows['M_NAME']) ?>
                                               </span>
                                           </div>
                                       </td>
                                       <td class="px-6 py-4 text-slate-600"><?= htmlspecialchars($rows['BARANGAY']) ?></td>
