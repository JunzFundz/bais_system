<div class="w-full p-5 sm:p-10 md:p-16 dark:bg-gray-900">

    <section class="bg-white dark:bg-gray-900 border-2 rounded-2xl border-gray-400 dark:border-gray-600">
        ...
        <article class="mb-10 rounded-xl dark:text-white dark:bg-gray-800 overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col mx-auto border border-gray-400 dark:border-gray-600">
            ...
            <div class="p-6">
                <a href="?post=<?php echo $post['id']; ?>"
                    class="ext-2xl sm:text-2xl md:text-3xl font-bold inline-block hover:text-indigo-600 transition-all duration-500 ease-in-out mb-4 line-clamp-2 leading-tight">
